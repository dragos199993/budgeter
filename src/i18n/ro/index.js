export default {
  ...
  user: {
    ...
    email: 'Adresa email',
    password: 'Parola',
    repeatPassword: 'Repeata parola'
  },
  login: {
    title: 'Conecteaza-te cu contul tau',
    switchSignup: 'Pentru a avea acces trebuie sa folosesti un cont existent, daca nu ai un cont, creeaza-ti unul de ',
    switchSignupTarget: 'aici.'
  },
  register: {
    title: 'Creeaza-ti un cont pentru a putea folosi aplicatia',
    switchSignin: 'Daca deja ai un cont, te poti autentifica de ',
    switchSigninTarget: 'here.'
  }
}
